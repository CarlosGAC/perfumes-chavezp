...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { day: @schedule.day, hour: @schedule.hour, place: @schedule.place } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { day: @schedule.day, hour: @schedule.hour, place: @schedule.place } }
